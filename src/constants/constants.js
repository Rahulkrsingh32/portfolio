export const projects = [
  ...
  },
  {
    ...
    description: "It is the Basic Demo website built with React, CSS, Bootstrap. this website has tons of amazing animations which makes it look facinating. This website can be used by anyone by just making some changes to its source code. Do check it out",
    image: '/images/4.png',
    tags: ['React', 'CSS', 'Bootstrap'],
...
export const TimeLineData = [
  { year: 2016, text: 'Passed Std X from CBSE', },
